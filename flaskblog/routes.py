...
posts = [
    {
        'author': 'Sudipto Shahin',
        'title': 'Blog post 1',
        'content': 'First post content',
        'date_posted': 'Janyary 19, 2022'
    },
    {
        'author': 'Sudipto',
        'title': 'Blog post 2',
        'content': 'Second post content',
        'date_posted': 'Janyary 17, 2022'
    },
]
...
# @app.route('/home')
# def home():
#     return '<h2 style="text-align:center;">Home page</h2>'

### with rendering the template
@app.route('/')
@app.route('/home')
def home(title='Home'):
...
def register():
    ...
    if form.validate_on_submit():
        ...
        flash(f'Your account is created successfully! You are now able to log in', 'success')
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash('Login unsuccessful. Please check the username/email and password.', 'danger')
